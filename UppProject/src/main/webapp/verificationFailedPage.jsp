...
<body>
	<div id="container" style="width: 20%;height: 22%;top: 0px;left: 0px;margin-top: 15%;margin-left: 40%;">
		...
		<fieldset>
		<h2 style="padding-left: 50px;padding-top: 10px;">Isteklo je vrijeme za potvrdu registracije!</h2>
		<h2 style="padding-left: 80px;padding-top: 10px;">Kliknite za ponovnu registraciju!</h2>
			
		 <div  class="upperLine" style="margin-top: 25px;width: 60%;">
			<input type="submit"  class="login" value="Registracija" style="width: 100px;">
		</div>
