...
<body>
	<div id="container" style="height: 190px;">
		<h2 style="text-align: center;padding-top: 10px;padding-bottom: 10px;">Ocjenjivanje klijenta: ${clientId}</h2>
		<hr>
			<form name='f' action="<c:url value='/submitRatingClient' />"method='POST'>
