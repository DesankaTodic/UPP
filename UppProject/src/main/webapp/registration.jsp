...
<html>
	...
	<body>
		...
		<div id="container" style="width: 20%;height: 43%;top: 0px;left: 0px;margin-top: 10%;margin-left: 40%;">
			<h2 style="text-align: center;padding-top: 10px;padding-bottom: 10px;">Registracija</h2>
			<c:if test="${fn:length(formProperties) > 0}">

				<form name='f' action="<c:url value='/submitRegistartion' />" method='POST'>
