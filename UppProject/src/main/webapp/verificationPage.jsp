...
<body>
	<div id="container" style="height: 215px;">
		<h2 style="text-align: center;padding-top: 10px;padding-bottom: 10px;">Verifikacija</h2>
		<hr>
		<form name='f' action="<c:url value='/login' />"method='GET'>
		
			<fieldset>
			<h2 style="padding-left: 40px;padding-top: 25px;">Uspjesno ste potvrdili registraciju!</h2>
